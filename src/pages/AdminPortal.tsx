    ...
    <div data-theme="light" style={{ colorScheme: 'light' }} className="min-h-screen bg-slate-50">
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <Tabs defaultValue="challenges">
          <TabsList className="flex w-full max-w-full overflow-x-auto bg-white border border-slate-200 rounded-xl p-1 pb-2 h-auto justify-start gap-0.5 [scrollbar-width:thin] [scrollbar-color:#cbd5e1_transparent] [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-300 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-slate-400">
