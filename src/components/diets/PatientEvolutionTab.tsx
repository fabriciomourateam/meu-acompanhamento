...
const STAT_TONES: Record<StatTone, { card: string; iconBox: string; value: string; subtitle: string; accentBar: string }> = {
  ...
  cyan: {
    card: 'from-cyan-50/80 dark:from-cyan-950/40 via-white to-teal-50/30 dark:to-teal-950/40 border-cyan-100/80 hover:border-cyan-200 hover:shadow-cyan-200/50',
  ...
  indigo: {
    card: 'from-indigo-50/80 dark:from-indigo-950/40 via-white to-blue-50/30 dark:to-blue-950/40 border-indigo-100/80 hover:border-indigo-200 hover:shadow-indigo-200/50',
  ...
  sky: {
    card: 'from-sky-50/80 dark:from-sky-950/40 via-white to-blue-50/30 dark:to-blue-950/40 border-sky-100/80 hover:border-sky-200 hover:shadow-sky-200/50',
  ...
  slate: {
    card: 'from-slate-50/80 dark:from-slate-900 via-white to-slate-50/30 dark:to-slate-900 border-slate-200/80 hover:border-slate-300 hover:shadow-slate-200/50',
