...
import { Utensils, Target, Trophy, BarChart2, Users, Dumbbell, Headset } from 'lucide-react';

type TabValue = 'diet' | 'workout' | 'challenges' | 'ranking' | 'community' | 'results' | 'support';
